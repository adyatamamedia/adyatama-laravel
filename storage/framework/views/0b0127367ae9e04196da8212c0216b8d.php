<?php $__env->startSection('content'); ?>
        ...
        <div class="container mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
            <div>
                <p class="text-sm uppercase tracking-[0.4em] text-sky-500 font-semibold mb-4">
                    <?php echo e($settings['site_name'] ?? 'Adyatama Islamic School'); ?></p>
                <h1 class="text-4xl md:text-5xl font-bold leading-tight text-slate-900 mb-6">
                    <?php echo e($settings['site_tagline'] ?? 'Membentuk Generasi Qurani dan Berprestasi'); ?></h1>
                <p class="text-lg text-slate-600 mb-8">
                    <?php echo e($settings['site_description'] ?? 'Sekolah Islam terpadu dengan fokus pada karakter dan prestasi akademik.'); ?>
            ...
            <div class="relative">
                ...
                <div class="relative bg-white rounded-3xl shadow-xl overflow-hidden">
                    ...
                    <?php if($heroImage): ?>
                        <img src="<?php echo e($heroImage); ?>" alt="<?php echo e($settings['site_name'] ?? 'Hero Image'); ?>"
                            class="w-full h-auto">
    ...
    <?php if(isset($welcomeMessage) && $welcomeMessage): ?>
                ...
                <div class="grid md:grid-cols-10 gap-6 items-center">
                    ...
                    <div class="md:col-span-3 flex justify-center md:justify-start">
                        <div class="relative w-[150px] md:w-full aspect-square md:aspect-[5/4]">
                            ...
                            <div class="relative rounded-2xl overflow-hidden shadow-lg w-full h-full">
                                <?php if($welcomeMessage->featured_image_url): ?>
                                    <img src="<?php echo e($welcomeMessage->featured_image_url); ?>" alt="Kepala Sekolah"
                    ...
                    <div class="md:col-span-7">
                        ...
                        <h2 class="text-3xl md:text-4xl font-bold text-white mb-6 leading-tight">
                            <?php echo e($welcomeMessage->title); ?>

                        </h2>
                        <div class="prose prose-invert text-slate-300 mb-8 leading-relaxed">
                            <p><?php echo e(Str::limit(strip_tags($welcomeMessage->content), 400)); ?></p>
                        </div>
                        ...
                        <a href="/posts/<?php echo e($post->slug); ?>"
                            ...
                            <div class="p-5 flex flex-col flex-1">
                                ...
                                <div
                                    ...
                                    <?php echo e($post->published_at?->format('d M Y') ?? $post->created_at->format('d M Y')); ?>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-nowrap overflow-x-auto snap-x snap-mandatory gap-6 pb-8 -mx-4 px-4 scrollbar-hide md:grid md:grid-cols-3 md:overflow-visible md:pb-0 md:mx-0 md:px-0"
                ...
                <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="/galleries/<?php echo e($gallery->slug); ?>"
                        ...
                        <div class="relative">
                            ...
                            <?php if($cover): ?>
                                <img src="<?php echo e($cover); ?>" alt="<?php echo e($gallery->title); ?>"
                                    class="aspect-[4/3] w-full object-cover">
                            <?php else: ?>
                                <div
                                    class="aspect-[4/3] bg-slate-200 flex items-center justify-center text-slate-500 text-sm">
                                    <?php echo e($gallery->items->first()->caption ?? 'Galeri Sekolah'); ?>
                            ...
                            <div
                                ...
                                <p class="text-white font-bold mb-2 line-clamp-2"><?php echo e($gallery->title); ?></p>
                                <div class="flex items-center gap-3 text-xs text-white/80">
                                    ...
                                    <div class="flex items-center gap-1">
                                        ...
                                        <span><?php echo e($gallery->view_count ?? 0); ?></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="p-4 md:hidden">
                            <h3 class="font-bold text-slate-900 mb-2 line-clamp-2"><?php echo e($gallery->title); ?></h3>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-4 gap-6">
                <?php $__currentLoopData = $guru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('guru-staff.show', $person->id)); ?>"
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                ...
                                <?php if($person->photo_url): ?>
                                    <img src="<?php echo e($person->photo_url); ?>" alt="<?php echo e($person->nama_lengkap); ?>"
                                        class="h-full w-full object-cover">
                                <?php else: ?>
                                    <div
                                        class="h-full w-full flex items-center justify-center bg-white/10 text-lg font-semibold text-slate-300">
                                        <?php echo e(strtoupper(mb_substr($person->nama_lengkap, 0, 1))); ?>
                            ...
                            <div class="min-w-0">
                                <p class="font-semibold truncate group-hover:text-sky-300 transition">
                                    <?php echo e($person->nama_lengkap); ?></p>
                                <p class="text-sm text-slate-400 truncate"><?php echo e($person->jabatan ?? 'Guru'); ?></p>
                            </div>
                        </div>
                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <section class="py-16">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-3xl font-bold mb-4">Siap bergabung dengan <?php echo e($settings['site_name'] ?? 'ADYATAMA SCHOOL'); ?>?
            </h2>
