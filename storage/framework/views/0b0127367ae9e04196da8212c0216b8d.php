        ...
        <div class="relative group/carousel">
            ...
            <div class="flex flex-nowrap overflow-x-auto snap-x snap-mandatory gap-6 pb-8 -mx-4 px-4 scrollbar-hide" style="scrollbar-width: none; -ms-overflow-style: none;">
                <?php $__currentLoopData = $latestPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="/posts/<?php echo e($post->slug); ?>" class="snap-start shrink-0 w-[85vw] md:w-[calc(50%-1.5rem)] lg:w-[calc(25%-1.125rem)] group bg-white border border-slate-100 rounded-2xl overflow-hidden hover:shadow-xl hover:border-sky-200 transition-all duration-300 flex flex-col h-full">
                        <!-- Image -->
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="/galleries/<?php echo e($gallery->slug); ?>" class="group rounded-3xl overflow-hidden border border-slate-100 bg-slate-50">
                    <div class="relative">
                        <?php ($cover = $gallery->items->first()?->image_url); ?>
                        <?php if($cover): ?>
                            <img src="<?php echo e($cover); ?>" alt="<?php echo e($gallery->title); ?>" class="aspect-[4/3] w-full object-cover">
                        <?php else: ?>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-4 gap-6">
            <?php $__currentLoopData = $guru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('guru-staff.show', $person->id)); ?>" class="group bg-white/5 border border-white/10 rounded-2xl p-4 hover:bg-white/10 transition duration-300">
                    <div class="flex items-center gap-4">
                        <div class="h-16 w-16 rounded-full overflow-hidden border-2 border-white/20 group-hover:border-sky-400 transition flex-shrink-0">
                            <?php if($person->photo_url): ?>
                                <img src="<?php echo e($person->photo_url); ?>" alt="<?php echo e($person->nama_lengkap); ?>" class="h-full w-full object-cover">
                            <?php else: ?>
                        ...
                        <div class="min-w-0">
                            <p class="font-semibold truncate group-hover:text-sky-300 transition"><?php echo e($person->nama_lengkap); ?></p>
