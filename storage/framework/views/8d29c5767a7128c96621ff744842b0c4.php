            ...
            <?php if($authors->count() > 0): ?>
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    <?php $__currentLoopData = $authors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('authors.show', $author)); ?>" class="group bg-white border border-slate-200 rounded-2xl p-6 hover:shadow-xl hover:border-primary-300 transition-all duration-300">
                            <div class="flex flex-col items-center text-center">
                                ...
                                <?php if($author->username): ?>
                                    <p class="text-sm text-slate-500 mb-3"><?php echo e('@' . $author->username); ?></p>
                                <?php endif; ?>
                                ...
                                <div class="flex items-center gap-4 text-sm">
                                    <div class="flex items-center gap-1 text-slate-600">
                                        ...
                                        <span class="font-semibold"><?php echo e(number_format($author->posts_count)); ?></span>
                                    </div>
                                </div>
...
], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\adyatama-school2\resources\views/authors/index.blade.php ENDPATH**/ ?>