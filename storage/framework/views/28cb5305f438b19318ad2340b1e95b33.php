        ...
        <div class="text-center mb-8">
            ...
            <nav class="mb-4 flex justify-center">
                <ol class="flex items-center gap-2 text-sm text-slate-600">
                    ...
                    <li class="font-medium text-slate-900"><?php echo e($page->title); ?></li>
                </ol>
            </nav>

            <h1 class="text-4xl lg:text-5xl font-bold text-slate-900 mb-3"><?php echo e($page->title); ?></h1>
            <?php if($page->excerpt): ?>
                <p class="text-slate-600 max-w-2xl mx-auto"><?php echo e($page->excerpt); ?></p>
            <?php endif; ?>
        </div>
    </div>
</section>
            ...
            <div class="bg-white border border-slate-100 rounded-2xl p-8 lg:p-12 shadow-sm">
                ...
                <div class="mt-12 pt-8 border-t border-slate-200">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <!-- Twitter/X -->
                        <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(request()->fullUrl())); ?>&text=<?php echo e(urlencode($page->title)); ?>" 
                           target="_blank" 
                           rel="noopener noreferrer"
                        ...
                        <!-- WhatsApp -->
                        <a href="https://wa.me/?text=<?php echo e(urlencode($page->title . ' - ' . request()->fullUrl())); ?>" 
                           target="_blank" 
                           rel="noopener noreferrer"
...
<?php echo $__env->make('layouts.public', [
    ...
    'type' => 'article'
], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\adyatama-school2\resources\views/pages/show.blade.php ENDPATH**/ ?>