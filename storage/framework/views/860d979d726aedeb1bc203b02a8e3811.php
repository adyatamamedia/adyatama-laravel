        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <article class="lg:col-span-8">
                <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                    ...
                    <div class="p-6 lg:p-10">
                        <!-- Breadcrumb -->
                        <nav class="flex items-center gap-1 md:gap-2 text-xs md:text-sm mb-6 flex-wrap" aria-label="Breadcrumb">
                            <a href="/" class="text-slate-500 hover:text-sky-600 transition-colors hidden md:inline">Beranda</a>
                            <svg class="w-3 h-3 md:w-4 md:h-4 text-slate-400 hidden md:inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                            <a href="<?php echo e(route('posts.index')); ?>" class="text-slate-500 hover:text-sky-600 transition-colors">Berita</a>
                            <?php if($post->category): ?>
                            <svg class="w-3 h-3 md:w-4 md:h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                            <a href="<?php echo e(route('posts.index', ['category' => $post->category->slug])); ?>" class="text-slate-500 hover:text-sky-600 transition-colors"><?php echo e($post->category->name); ?></a>
                            <?php endif; ?>
                            <svg class="w-3 h-3 md:w-4 md:h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                            <span class="text-slate-900 font-medium truncate max-w-[150px] md:max-w-none"><?php echo e(Str::limit($post->title, 30)); ?></span>
                        </nav>

                        <!-- Meta -->
                        <div class="flex items-center gap-2 md:gap-3 mb-4 flex-wrap text-sm">
                            <a href="<?php echo e(route('posts.index', ['category' => $post->category->slug ?? ''])); ?>" class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-primary-50 text-primary-700 hover:bg-primary-100 transition-colors">
                                <?php echo e($post->category->name ?? 'Berita'); ?>
                            ...
                            <div class="hidden md:flex items-center gap-1 text-slate-500">
                                ...
                                <span><?php echo e($post->published_at?->format('H:i')); ?> WIB</span>
                            </div>
                            <div class="flex items-center gap-1 text-slate-500">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                </svg>
                                <span><?php echo e($post->author?->fullname ?? 'Admin'); ?></span>
                            </div>
                            <div class="flex items-center gap-1 text-slate-500">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span><?php echo e(number_format($post->view_count ?? 0)); ?></span>
                            </div>
                        </div>
                        
                        <!-- Title -->
                        <h1 class="text-3xl lg:text-4xl font-bold text-slate-900 mb-4 leading-tight"><?php echo e($post->title); ?></h1>

                        <!-- Excerpt -->
                        <?php if($post->excerpt): ?>
                        <p class="text-sm text-slate-600 mb-6 leading-relaxed italic lg:hidden">
                            <?php echo e(Str::words($post->excerpt, 20, '...')); ?>

                        </p>
                        <p class="text-sm text-slate-600 mb-6 leading-relaxed italic hidden lg:block">
                            <?php echo e(Str::words($post->excerpt, 35, '...')); ?>
                        ...
                        <div class="mb-6">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex gap-2">
                                    <a href="https://wa.me/?text=<?php echo e(urlencode($post->title.' '.url()->current())); ?>" target="_blank" class="group w-9 h-9 flex items-center justify-center rounded-full bg-[#25D366] text-white hover:scale-110 hover:shadow-lg transition-all duration-200" title="WhatsApp">
                                    ...
                                    <a href="https://facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(url()->current())); ?>" target="_blank" class="group w-9 h-9 flex items-center justify-center rounded-full bg-[#1877F2] text-white hover:scale-110 hover:shadow-lg transition-all duration-200" title="Facebook">
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                                    </a>
                                    <a href="https://t.me/share/url?url=<?php echo e(urlencode(url()->current())); ?>&text=<?php echo e(urlencode($post->title)); ?>" target="_blank" class="group w-9 h-9 flex items-center justify-center rounded-full bg-[#0088cc] text-white hover:scale-110 hover:shadow-lg transition-all duration-200" title="Telegram">
                    ...
                    <?php if($post->post_type === 'video' && $post->video_url): ?>
                        ...
                        <?php if($videoId): ?>
                            ...
                            <div class="relative bg-black">
                                <a href="https://www.youtube.com/watch?v=<?php echo e($videoId); ?>" 
                                   target="_blank" 
                                   rel="noopener"
                                   class="block relative w-full aspect-video overflow-hidden bg-black group/thumb">
                                    ...
                                    <!-- YouTube Thumbnail -->
                                    <img 
                                        src="https://img.youtube.com/vi/<?php echo e($videoId); ?>/maxresdefault.jpg" 
                                        alt="<?php echo e($post->title); ?>"
                                        class="w-full h-full object-cover"
                                        onerror="this.onerror=null; this.src='https://img.youtube.com/vi/<?php echo e($videoId); ?>/hqdefault.jpg';">
                                    ...
                                    <div class="absolute bottom-0 left-0 right-0 p-6 text-white">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <p class="text-sm font-semibold line-clamp-2 mb-1"><?php echo e($post->title); ?></p>
                                ...
                                <?php if($post->featuredMedia?->caption): ?>
                                    <div class="px-6 py-3 bg-slate-50 border-t border-slate-100">
                                        <p class="text-xs text-slate-600 italic"><?php echo e($post->featuredMedia->caption); ?></p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        <?php else: ?>
                            ...
                            <div class="bg-slate-100 p-8 text-center rounded-lg border border-slate-200">
                                ...
                                <div class="bg-white rounded-lg p-3 mb-4 text-left">
                                    ...
                                    <code class="text-xs text-slate-700 break-all"><?php echo e($post->video_url); ?></code>
                                </div>
                                <a href="<?php echo e($post->video_url); ?>" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-medium">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                                    </svg>
                                    Tonton di YouTube
                        ...
                        <?php endif; ?>
                    <?php elseif($post->featured_image_url): ?>
                        <div class="relative bg-slate-100 cursor-pointer" onclick="openLightbox('<?php echo e($post->featured_image_url); ?>')">
                            <div class="aspect-video w-full overflow-hidden">
                                <img src="<?php echo e($post->featured_image_url); ?>" alt="<?php echo e($post->title); ?>" class="w-full h-full object-cover">
                            </div>
                            <?php if($post->featuredMedia?->caption): ?>
                                <div class="px-6 py-3 bg-slate-50 border-t border-slate-100">
                                    <p class="text-xs text-slate-600 italic"><?php echo e($post->featuredMedia->caption); ?></p>
                    ...
                    <div class="p-6 lg:p-10">
                        ...
                        <?php if($post->tags->count()): ?>
                            <div class="flex flex-wrap gap-2 mb-8">
                                <?php $__currentLoopData = $post->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('posts.index', ['tag' => $tag->name])); ?>" class="px-3 py-1.5 rounded-full text-sm bg-slate-50 text-slate-600 hover:bg-primary-50 hover:text-primary-700 transition-colors border border-slate-200 hover:border-primary-200">
                                        #<?php echo e($tag->name); ?>
                        ...
                        <div class="mb-8 p-6 bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl border border-slate-200">
                            <div class="flex items-center gap-4">
                                <!-- Author Avatar -->
                                <a href="<?php echo e(route('authors.show', $post->author)); ?>" class="shrink-0">
                                    <?php if($post->author->photo_url): ?>
                                        <img src="<?php echo e($post->author->photo_url); ?>" 
                                             alt="<?php echo e($post->author->fullname); ?>" 
                                             class="w-20 h-20 rounded-full object-cover border-4 border-white shadow-md hover:scale-105 transition-transform">
                                    <?php else: ?>
                                        <div class="w-20 h-20 rounded-full bg-gradient-to-br from-primary-400 to-primary-600 flex items-center justify-center text-white text-2xl font-bold border-4 border-white shadow-md hover:scale-105 transition-transform">
                                            <?php echo e(strtoupper(substr($post->author->fullname, 0, 1))); ?>
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-2 mb-1">
                                        <p class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Ditulis Oleh</p>
                                    </div>
                                    <a href="<?php echo e(route('authors.show', $post->author)); ?>" class="group">
                                        ...
                                        <?php if($post->author->username): ?>
                                            <p class="text-sm text-slate-600"><?php echo e('@' . $post->author->username); ?></p>
                                        <?php endif; ?>
                                    </a>
                                    <div class="flex items-center gap-4 mt-2">
                                        <a href="<?php echo e(route('authors.show', $post->author)); ?>" class="inline-flex items-center gap-1 text-sm text-primary-600 hover:text-primary-700 font-medium transition-colors">
                                            Lihat Profil
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-8 pb-8 border-b border-slate-100">
                            <div class="flex items-center gap-2 flex-wrap">
                                <?php $__currentLoopData = $reactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button 
                                        onclick="addReaction(<?php echo e($post->id); ?>, <?php echo e($reaction->id); ?>)"
                                        data-reaction-id="<?php echo e($reaction->id); ?>"
                                        ...
                                        <span class="text-xl group-hover:scale-110 transition-transform"><?php echo e($reaction->emoji); ?></span>
                                        <span class="text-xs font-semibold text-slate-600 group-hover:text-primary-700"><?php echo e($reaction->label); ?></span>
                                        <span class="reaction-count text-xs font-bold text-primary-600 ml-1" data-count="<?php echo e($reaction->reactions_count ?? 0); ?>">
                                            <?php echo e($reaction->reactions_count > 0 ? $reaction->reactions_count : ''); ?>
                        ...
                        <!-- Comments Section -->
                        <div class="mt-4">
                            <h3 class="text-2xl font-bold text-slate-900 mb-6">Komentar (<?php echo e($post->comments_count ?? 0); ?>)</h3>
                            ...
                            <!-- Comment Form -->
                            <form action="<?php echo e(route('comments.store', $post->slug)); ?>" method="POST" class="mb-8 bg-slate-50 p-6 rounded-xl">
                                <?php echo csrf_field(); ?>
                                        ...
                                        <div class="flex gap-4 p-4 rounded-xl hover:bg-slate-50 transition-colors">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center justify-between gap-3 mb-2">
                                                    ...
                                                    <button onclick="toggleReplyForm(<?php echo e($comment->id); ?>)" class="text-sm text-primary-600 hover:text-primary-700 font-medium flex items-center gap-1">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <p class="text-slate-600 leading-relaxed mb-3"><?php echo e($comment->content); ?></p>

                                                <!-- Reply Form -->
                                                <div id="reply-form-<?php echo e($comment->id); ?>" class="hidden mt-4 ml-12 p-4 bg-slate-50 rounded-lg border border-slate-200">
                                                    <form action="<?php echo e(route('comments.store', $post->slug)); ?>" method="POST" class="space-y-3">
                                                        <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="flex gap-2">
                                                            ...
                                                            <button type="button" onclick="toggleReplyForm(<?php echo e($comment->id); ?>)" class="px-4 py-2 bg-slate-200 text-slate-700 text-sm font-semibold rounded-lg hover:bg-slate-300 transition-colors">
                                                                Batal
                                                            </button>
                                                        </div>
                                                    </form>
                                            ...
                                            <div class="ml-12 mt-4 space-y-4 border-l-2 border-primary-200 pl-4">
                                                <?php $__currentLoopData = $comment->replies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="flex gap-4 p-3 rounded-lg bg-slate-50">
                                                        ...
                                                        <div class="flex-1 min-w-0">
                                                            <div class="flex items-center gap-2 mb-1">
                                                                <h4 class="font-bold text-slate-900 text-sm"><?php echo e($reply->author_name); ?></h4>
                                                                <span class="text-xs text-slate-400"><?php echo e($reply->created_at->diffForHumans()); ?></span>
                                                            </div>
                                                            <p class="text-slate-600 text-sm leading-relaxed"><?php echo e($reply->content); ?></p>
                                                        </div>
                                                    </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                        ...
                        <div class="mt-12 pt-12 border-t border-slate-100">
                            <div class="mb-8 flex items-center justify-between">
                                ...
                                <a href="<?php echo e(route('posts.index')); ?>" class="text-sky-600 font-semibold text-sm hover:text-sky-700 transition-colors flex items-center gap-1">
                                    Lihat semua
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                    </svg>
                            ...
                            <div class="relative group/carousel">
                                ...
                                <div class="flex flex-nowrap overflow-x-auto snap-x snap-mandatory gap-6 pb-8 -mx-4 px-4 scrollbar-hide" style="scrollbar-width: none; -ms-overflow-style: none;">
                                    <?php $__currentLoopData = $related; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="/posts/<?php echo e($item->slug); ?>" class="snap-start shrink-0 w-[85vw] md:w-[calc(50%-1.5rem)] lg:w-[calc(33.333%-1.5rem)] group bg-white border border-slate-100 rounded-2xl overflow-hidden hover:shadow-xl hover:border-sky-200 transition-all duration-300 flex flex-col h-full">
                                            <!-- Image -->
                                            <div class="relative aspect-[4/3] overflow-hidden bg-slate-100">
                                                <?php if($item->featured_image_url): ?>
                                                    <img src="<?php echo e($item->featured_image_url); ?>" 
                                                ...
                                                <!-- Video Badge -->
                                                <?php if($item->post_type === 'video' && $item->video_url): ?>
                                                    <div class="absolute inset-0 flex items-center justify-center">
                                                ...
                                                <div class="absolute top-3 left-3 bg-white/90 backdrop-blur px-3 py-1 rounded-full text-xs font-semibold text-slate-700 shadow-sm">
                                                    <?php echo e($item->category->name ?? 'Berita'); ?>
                                            ...
                                            <div class="p-5 flex flex-col flex-1">
                                                ...
                                                <p class="text-slate-500 text-sm line-clamp-2 mb-4 flex-1">
                                                    <?php echo e($item->excerpt ?? Str::limit(strip_tags($item->content), 100)); ?>
                                                ...
                                                <div class="flex items-center text-xs text-slate-400 font-medium pt-4 border-t border-slate-50 mt-auto">
                                                    ...
                                                    <?php echo e($item->published_at?->format('d M Y') ?? $item->created_at->format('d M Y')); ?>
            ...
            <aside class="lg:col-span-4">
                <div class="sticky top-8 space-y-6">
                    ...
                    <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                        ...
                        <div class="space-y-4">
                            <?php $__currentLoopData = $popular_posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="/posts/<?php echo e($item->slug); ?>" class="group flex gap-3 items-start p-2 -m-2 rounded-lg hover:bg-slate-50 transition-colors">
                                    <div class="shrink-0 w-16 h-16 rounded-lg overflow-hidden bg-slate-100 relative">
                                        <?php if($item->featured_image_url): ?>
                                            <img src="<?php echo e($item->featured_image_url); ?>" alt="<?php echo e($item->title); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                                        <?php else: ?>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h4 class="text-sm font-semibold text-slate-800 leading-snug group-hover:text-primary-600 transition-colors line-clamp-2 mb-1"><?php echo e($item->title); ?></h4>
                                        <div class="flex items-center gap-2 text-xs text-slate-500">
                                            <time><?php echo e($item->published_at?->format('d M Y')); ?></time>
                                            <span>•</span>
                                            <span class="flex items-center gap-1">
                                                ...
                                                <?php echo e(number_format($item->view_count ?? 0)); ?>
                    ...
                    <!-- Recent Posts Widget -->
                    <?php if($recent_posts->count()): ?>
                    <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                        <div class="flex items-center justify-between mb-5">
                            <h3 class="font-bold text-slate-900 text-lg">Artikel Terbaru</h3>
                            <a href="<?php echo e(route('posts.index')); ?>" class="text-xs font-semibold text-primary-600 hover:text-primary-700 transition-colors">Semua →</a>
                        </div>
                        <div class="space-y-4">
                            <?php $__currentLoopData = $recent_posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="/posts/<?php echo e($item->slug); ?>" class="group flex gap-3 items-start p-2 -m-2 rounded-lg hover:bg-slate-50 transition-colors">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h4 class="text-sm font-semibold text-slate-800 leading-snug group-hover:text-primary-600 transition-colors line-clamp-2 mb-1"><?php echo e($item->title); ?></h4>
                                        <time class="text-xs text-slate-500"><?php echo e($item->published_at?->format('d M Y')); ?></time>
                                    </div>
                                </a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    ...
                    <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                        ...
                        <ul class="space-y-1">
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a href="<?php echo e(route('posts.index', ['category' => $category->slug])); ?>" class="flex items-center justify-between group py-2.5 px-3 -mx-3 rounded-lg hover:bg-slate-50 transition-colors">
                                        <span class="text-sm text-slate-700 group-hover:text-primary-600 font-medium transition-colors"><?php echo e($category->name); ?></span>
                                        <span class="text-xs bg-slate-100 text-slate-600 px-2.5 py-1 rounded-full group-hover:bg-primary-100 group-hover:text-primary-700 transition-colors font-medium"><?php echo e($category->posts_count); ?></span>
                                    </a>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    ...
                    <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('posts.index', ['tag' => $tag->name])); ?>" class="inline-flex items-center px-3 py-1.5 bg-slate-50 text-slate-600 text-xs font-medium rounded-lg hover:bg-primary-50 hover:text-primary-700 transition-colors border border-slate-200 hover:border-primary-200">
                                    #<?php echo e($tag->name); ?>
...
<?php echo $__env->make('layouts.public', [
    ...
    'type' => 'article'
], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\adyatama-school2\resources\views/posts/show.blade.php ENDPATH**/ ?>