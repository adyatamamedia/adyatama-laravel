                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                    ...
                    <div class="p-6 lg:p-10">
                        ...
                        <nav class="flex items-center gap-2 text-sm mb-6" aria-label="Breadcrumb">
                            ...
                            <span class="text-slate-900 font-medium"><?php echo e(Str::limit($post->title, 50)); ?></span>
                        </nav>
                        ...
                        <div class="flex items-center justify-between gap-3 mb-4 flex-wrap">
                            ...
                            <div class="flex items-center gap-2 text-sm text-slate-500">
                                ...
                                <span><?php echo e(number_format($post->view_count ?? 0)); ?> views</span>
                            </div>
                        </div>
                        ...
                        <p class="text-lg text-slate-600 mb-6 leading-relaxed">
                            <?php echo e(Str::limit($post->excerpt, 200)); ?>
                        ...
                        <?php if($post->tags->count()): ?>
                            <div class="flex flex-wrap gap-2 mb-8 pb-8 border-b border-slate-100">
                                <?php $__currentLoopData = $post->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('posts.index', ['q' => $tag->name])); ?>" class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm bg-slate-50 text-slate-600 hover:bg-slate-100 transition-colors">
                                        #<?php echo e($tag->name); ?>
                    ...
                    <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('posts.index', ['q' => $tag->name])); ?>" class="inline-flex items-center px-3 py-1.5 bg-slate-50 text-slate-600 text-xs font-medium rounded-lg hover:bg-primary-50 hover:text-primary-700 transition-colors border border-slate-200 hover:border-primary-200">
                                    #<?php echo e($tag->name); ?>
...
<?php echo $__env->make('layouts.public', ['title' => $post->title], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\adyatama-school2\resources\views/posts/show.blade.php ENDPATH**/ ?>