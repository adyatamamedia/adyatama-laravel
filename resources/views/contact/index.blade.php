...
<section class="py-12 bg-white">
    <div class="container mx-auto px-4">
        <div class="max-w-5xl mx-auto">
                ...
                <div class="bg-white border border-slate-100 rounded-2xl p-6 hover:shadow-lg transition-shadow">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-slate-600 text-sm leading-relaxed">{{ $settings['address'] ?? 'Alamat belum tersedia' }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-slate-100 rounded-2xl p-6 hover:shadow-lg transition-shadow">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <a href="tel:{{ $settings['phone'] ?? '' }}" class="text-slate-600 text-sm hover:text-primary-600 transition-colors">
                                {{ $settings['phone'] ?? 'Telepon belum tersedia' }}
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-slate-100 rounded-2xl p-6 hover:shadow-lg transition-shadow">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <a href="mailto:{{ $settings['email'] ?? '' }}" class="text-slate-600 text-sm hover:text-primary-600 transition-colors break-all">
                                {{ $settings['email'] ?? 'Email belum tersedia' }}
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings['whatsapp'] ?? '') }}" 
                               ...
                               class="text-slate-600 text-sm hover:text-primary-600 transition-colors">
                                {{ $settings['whatsapp'] ?? 'WhatsApp belum tersedia' }}
                            </a>
                        </div>
                    </div>
                </div>
            ...
            @if(isset($settings['facebook']) || isset($settings['instagram']) || isset($settings['youtube']))
