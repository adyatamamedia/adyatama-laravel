        ...
        <div class="text-center mb-8">
            ...
            <nav class="mb-4 flex justify-center">
                <ol class="flex items-center gap-2 text-sm text-slate-600">
                    ...
                    <li class="font-medium text-slate-900">{{ $person->nama_lengkap }}</li>
                </ol>
            </nav>

            <h1 class="text-4xl lg:text-5xl font-bold text-slate-900 mb-3">{{ $person->nama_lengkap }}</h1>
            <p class="text-lg text-primary-600 font-semibold">{{ $person->jabatan }}</p>
        </div>
    </div>
</section>
                    ...
                    <div class="flex flex-col lg:flex-row gap-8 items-start">
                        ...
                        <div class="w-full lg:w-64 flex-shrink-0">
                            <div class="aspect-[3/4] rounded-xl overflow-hidden bg-slate-100 border border-slate-200 shadow-md">
                                @if($person->photo_url)
                                    <img src="{{ $person->photo_url }}" alt="{{ $person->nama_lengkap }}" class="w-full h-full object-cover">
                                @else
                                ...
                                <div class="pb-6 border-b border-slate-100">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-lg font-semibold text-slate-900">{{ $person->bidang }}</p>
                                        </div>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="pb-6 border-b border-slate-100">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold {{ $person->status === 'aktif' ? 'bg-green-100 text-green-700' : 'bg-slate-100 text-slate-700' }}">
                                ...
                                <div class="pb-6 border-b border-slate-100">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-base font-mono font-semibold text-slate-900">{{ $person->nip }}</p>
                                        </div>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div>
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:{{ $person->email }}" class="text-base font-medium text-primary-600 hover:text-primary-700 transition-colors break-all">
                                                {{ $person->email }}
                                            </a>
                                        </div>
                                    </div>
