@extends('layouts.public', ['title' => $gallery->title])
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <nav class="mb-6 flex justify-center">
                <ol class="flex items-center gap-2 text-sm text-slate-600">
                    ...
                    <li>
                        <a href="{{ route('galleries.index') }}" class="hover:text-primary-600 transition-colors">Galeri</a>
                    </li>
                    <li>
                        <svg class="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    ...
                    <li class="font-medium text-slate-900">{{ Str::limit($gallery->title, 40) }}</li>
                </ol>
            </nav>
            ...
            <div class="text-center mb-6">
                ...
                <h1 class="text-4xl lg:text-5xl font-bold text-slate-900 mb-4 leading-tight">{{ $gallery->title }}</h1>
            </div>
            ...
            <div class="flex items-center justify-center gap-6 flex-wrap text-sm text-slate-600">
                <div class="flex items-center gap-2">
                    ...
                    <span class="font-medium">{{ $gallery->author?->fullname ?? 'Admin' }}</span>
                </div>
                <div class="flex items-center gap-2">
                    ...
                    <span>{{ $gallery->created_at?->format('H:i') }} WIB</span>
                </div>
                <div class="flex items-center gap-2">
                    <svg class="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="font-semibold text-primary-600">{{ number_format($gallery->view_count ?? 0) }}</span>
                    <span>views</span>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mt-12 pt-8 border-t border-slate-200">
                <div class="prose prose-slate max-w-none mb-8">
                    <p class="text-slate-700 leading-relaxed text-lg">{{ $gallery->description }}</p>
                </div>
            </div>
            @endif
